...
const singaporeVirtualTours: Record<string, VirtualPropertyTour> = {
  "marina-cove-28-08": {
    ...
    panoramaPreviewUrls: {
      living: "/manus-storage/marina-cove-living-noon-panorama-21x9_dd5467ff.jpg",
      ...
      room2: "/manus-storage/marina-cove-room2-panorama-clean-21x9_1333a966.jpg",
      room3: "/manus-storage/marina-cove-room3-panorama-clean-21x9_4b746f5d.jpg",
    },
    floors: [{ id: "main", label: "Main floor", roomIds: ["living", "kitchen", "utility", "primary", "room2", "room3"] }],
    rooms: [
      { id: "living", label: "Living / dining", imageIndex: 0, note: "Illustrative generated panorama-style preview; it is not a real property capture.", approvedHighlights: ["Illustrative generated media", "Timed panorama lighting", "Door-to-door navigation"], floorPlanPosition: { x: 26, y: 27 }, floorPlanBounds: { x: 5, y: 5, width: 42, height: 41 }, viewerPosition: { x: 50, y: 66 }, connections: [{ roomId: "kitchen", direction: "right" }, { roomId: "primary", direction: "down" }], timedPhotos: [
      ...
      ], panoramaPreviewByTiming: { morning: "/manus-storage/marina-cove-living-morning-panorama-21x9_de3edb0f.jpg", noon: "/manus-storage/marina-cove-living-noon-panorama-21x9_dd5467ff.jpg", night: "/manus-storage/marina-cove-living-night-panorama-21x9_1837773c.jpg" } },
      { id: "kitchen", label: "Kitchen", imageIndex: 1, note: "Illustrative generated panorama-style preview; it is not a real property capture.", approvedHighlights: ["Illustrative generated media", "Room sequence"], floorPlanPosition: { x: 73, y: 17 }, floorPlanBounds: { x: 51, y: 5, width: 44, height: 23 }, viewerPosition: { x: 68, y: 61 }, connections: [{ roomId: "living", direction: "left" }, { roomId: "utility", direction: "down" }], timedPhotos: [{ id: "morning", label: "Morning", timeRange: "7:30 AM", description: "Warm daylight treatment for this illustrative kitchen.", src: "/manus-storage/marina-cove-kitchen-panorama-six-room_25b6c8a9.jpg" }, { id: "noon", label: "Noon", timeRange: "12:30 PM", description: "Neutral daylight treatment for this illustrative kitchen.", src: "/manus-storage/marina-cove-kitchen-panorama-six-room_25b6c8a9.jpg" }, { id: "night", label: "Night", timeRange: "8:30 PM", description: "Bright interior lighting and a true illustrative night outlook for this kitchen.", src: "/manus-storage/marina-cove-kitchen-night-panorama_33cc3ce2.jpg" }], panoramaPreviewByTiming: { morning: "/manus-storage/marina-cove-kitchen-panorama-six-room_25b6c8a9.jpg", noon: "/manus-storage/marina-cove-kitchen-panorama-six-room_25b6c8a9.jpg", night: "/manus-storage/marina-cove-kitchen-night-panorama_33cc3ce2.jpg" } },
      { id: "utility", label: "Utility / bath", imageIndex: 2, note: "Illustrative generated panorama-style preview; it is not a real property capture.", approvedHighlights: ["Illustrative generated media", "Privacy-safe room preview"], floorPlanPosition: { x: 73, y: 39 }, floorPlanBounds: { x: 51, y: 32, width: 44, height: 15 }, viewerPosition: { x: 36, y: 56 }, connections: [{ roomId: "kitchen", direction: "up" }, { roomId: "room2", direction: "down" }], timedPhotos: [{ id: "morning", label: "Morning", timeRange: "7:30 AM", description: "Bright early daylight and a clear morning outlook for this illustrative utility room.", src: "/manus-storage/marina-cove-utility-morning-panorama_e2b676ad.jpg" }, { id: "noon", label: "Noon", timeRange: "12:30 PM", description: "Bright neutral midday daylight and exterior outlook for this illustrative utility room.", src: "/manus-storage/marina-cove-utility-noon-panorama_1f9dcbbc.jpg" }, { id: "night", label: "Night", timeRange: "8:30 PM", description: "Bright interior lighting and a true illustrative night outlook for this utility room.", src: "/manus-storage/marina-cove-utility-night-panorama_23684fa1.jpg" }], panoramaPreviewByTiming: { morning: "/manus-storage/marina-cove-utility-morning-panorama_e2b676ad.jpg", noon: "/manus-storage/marina-cove-utility-noon-panorama_1f9dcbbc.jpg", night: "/manus-storage/marina-cove-utility-night-panorama_23684fa1.jpg" } },
      { id: "primary", label: "Primary room", imageIndex: 2, note: "Illustrative generated panorama-style preview; request a real viewing to verify any actual property.", approvedHighlights: ["Illustrative generated media", "Viewing request available"], floorPlanPosition: { x: 20, y: 71 }, floorPlanBounds: { x: 5, y: 52, width: 29, height: 39 }, viewerPosition: { x: 34, y: 72 }, connections: [{ roomId: "living", direction: "up" }, { roomId: "room2", direction: "right" }], timedPhotos: [{ id: "morning", label: "Morning", timeRange: "7:30 AM", description: "Soft morning treatment for this illustrative primary room.", src: "/manus-storage/marina-cove-primary-panorama-six-room_f19cdf49.jpg" }, { id: "noon", label: "Noon", timeRange: "12:30 PM", description: "Neutral daylight treatment for this illustrative primary room.", src: "/manus-storage/marina-cove-primary-panorama-six-room_f19cdf49.jpg" }, { id: "night", label: "Night", timeRange: "8:30 PM", description: "Bright interior lighting and a true illustrative night outlook for this primary room.", src: "/manus-storage/marina-cove-primary-night-panorama_c6c1b5e1.jpg" }], panoramaPreviewByTiming: { morning: "/manus-storage/marina-cove-primary-panorama-six-room_f19cdf49.jpg", noon: "/manus-storage/marina-cove-primary-panorama-six-room_f19cdf49.jpg", night: "/manus-storage/marina-cove-primary-night-panorama_c6c1b5e1.jpg" } },
      { id: "room2", label: "Room 2", imageIndex: 2, note: "Illustrative generated panorama-style preview; request a real viewing to verify any actual property.", approvedHighlights: ["Illustrative generated media", "Viewing request available"], floorPlanPosition: { x: 50, y: 71 }, floorPlanBounds: { x: 36, y: 52, width: 28, height: 39 }, viewerPosition: { x: 58, y: 69 }, connections: [{ roomId: "primary", direction: "left" }, { roomId: "room3", direction: "right" }, { roomId: "utility", direction: "up" }], timedPhotos: [{ id: "morning", label: "Morning", timeRange: "7:30 AM", description: "Soft morning treatment for this illustrative Room 2.", src: "/manus-storage/marina-cove-room2-panorama-clean-21x9_1333a966.jpg" }, { id: "noon", label: "Noon", timeRange: "12:30 PM", description: "Neutral daylight treatment for this illustrative Room 2.", src: "/manus-storage/marina-cove-room2-panorama-clean-21x9_1333a966.jpg" }, { id: "night", label: "Night", timeRange: "8:30 PM", description: "Bright interior lighting and a true illustrative night outlook for Room 2.", src: "/manus-storage/marina-cove-room2-night-panorama_7b80ada2.jpg" }], panoramaPreviewByTiming: { morning: "/manus-storage/marina-cove-room2-panorama-clean-21x9_1333a966.jpg", noon: "/manus-storage/marina-cove-room2-panorama-clean-21x9_1333a966.jpg", night: "/manus-storage/marina-cove-room2-night-panorama_7b80ada2.jpg" } },
      { id: "room3", label: "Room 3", imageIndex: 2, note: "Illustrative generated panorama-style preview; request a real viewing to verify any actual property.", approvedHighlights: ["Illustrative generated media", "Viewing request available"], floorPlanPosition: { x: 80, y: 71 }, floorPlanBounds: { x: 66, y: 52, width: 29, height: 39 }, viewerPosition: { x: 74, y: 72 }, connections: [{ roomId: "room2", direction: "left" }], timedPhotos: [{ id: "morning", label: "Morning", timeRange: "7:30 AM", description: "Soft morning treatment for this illustrative Room 3.", src: "/manus-storage/marina-cove-room3-panorama-clean-21x9_4b746f5d.jpg" }, { id: "noon", label: "Noon", timeRange: "12:30 PM", description: "Neutral daylight treatment for this illustrative Room 3.", src: "/manus-storage/marina-cove-room3-panorama-clean-21x9_4b746f5d.jpg" }, { id: "night", label: "Night", timeRange: "8:30 PM", description: "Bright interior lighting and a true illustrative night outlook for Room 3.", src: "/manus-storage/marina-cove-room3-night-panorama_6d96debc.jpg" }], panoramaPreviewByTiming: { morning: "/manus-storage/marina-cove-room3-panorama-clean-21x9_4b746f5d.jpg", noon: "/manus-storage/marina-cove-room3-panorama-clean-21x9_4b746f5d.jpg", night: "/manus-storage/marina-cove-room3-night-panorama_6d96debc.jpg" } },
    ],
...
const marinaCoveMatchedTimingSources = {
  ...
  utility: {
    ...
    noon: "/manus-storage/marina-cove-utility-locked-noon-panorama_d4eea7b9.jpg",
    night: "/manus-storage/marina-cove-utility-locked-night-panorama_831829d0.jpg",
  },
  primary: {
