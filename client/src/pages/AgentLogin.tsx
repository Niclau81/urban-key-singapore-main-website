      ...
      <section className="grid overflow-hidden rounded-[2rem] bg-white shadow-[0_30px_100px_rgba(23,56,47,0.12)] lg:grid-cols-[1.02fr_.98fr]">
        <div className="relative px-6 py-10 sm:px-10 sm:py-14 lg:px-14 lg:py-20">
          ...
          <div className="relative max-w-xl">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row"><Button onClick={startLogin} size="lg" className="h-12 rounded-full bg-[#17382f] px-7 text-white shadow-lg shadow-[#17382f]/15 hover:bg-[#224a40]">Sign in to agent portal <ArrowRight className="ml-2 size-4" /></Button><Link href="/agent/signup"><Button size="lg" variant="outline" className="h-12 rounded-full border-[#17382f]/18 bg-white px-7">Create professional profile</Button></Link></div>
